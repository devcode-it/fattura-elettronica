...
class DatiGeneraliDocumento extends Elemento {
    ...
    public function __construct(?string $TipoDocumento = null, ?string $Divisa = null, null|string|Carbon|\DateTime $Data = null, ?string $Numero = null, ?string $BolloVirtuale = null) {
		...
		if (!is_null($BolloVirtuale)) $this->setBolloVirtuale($BolloVirtuale);
    }
