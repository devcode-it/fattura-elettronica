...
namespace DevCode\FatturaElettronica\Semplificata\FatturaElettronicaBody\DatiGenerali\DatiTrasporto;

use DevCode\FatturaElettronica\Semplificata\FatturaElettronicaBody\DatiGenerali\DatiTrasporto\DatiAnagraficiVettore\Anagrafica;
use DevCode\FatturaElettronica\Semplificata\FatturaElettronicaBody\DatiGenerali\DatiTrasporto\DatiAnagraficiVettore\IdFiscaleIVA;
...
class DatiAnagraficiVettore extends Elemento {
    ...
    public function __construct(?string $CodiceFiscale = null, ?string $NumeroLicenzaGuida = null) {
		...
		if (!is_null($NumeroLicenzaGuida)) $this->setNumeroLicenzaGuida($NumeroLicenzaGuida);
    }
